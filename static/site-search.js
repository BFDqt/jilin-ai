...
class SiteSearch {
  ...
  async buildDynamicIndex() {
    ...
    const pages = [
      ...
      { url: '{{ url_for("pages", page="software") }}', title: '软件', section: '干实验室' },
      { url: '{{ url_for("pages", page="timeline") }}', title: '时间线', section: '干实验室' },
      ...
      { url: '{{ url_for("pages", page="overview") }}', title: '模型总览', section: '模型' },
      { url: '{{ url_for("pages", page="model") }}', title: '模型详情', section: '模型' },
      { url: '{{ url_for("pages", page="results") }}', title: '结果展示', section: '模型' },
