...
class SearchIndexBuilder:
    ...
    # Page configuration
        self.page_config = {
            ...
            'software.html': {'title': 'Software', 'section': 'Dry Lab', 'url': '/pages/software'},
            'timeline.html': {'title': 'Timeline', 'section': 'Dry Lab', 'url': '/pages/timeline'},
            ...
            'overview.html': {'title': 'Model Overview', 'section': 'Model', 'url': '/pages/overview'},
            'model.html': {'title': 'Model Details', 'section': 'Model', 'url': '/pages/model'},
